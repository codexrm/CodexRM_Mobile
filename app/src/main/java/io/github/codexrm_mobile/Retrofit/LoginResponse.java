...
public class LoginResponse {
    ...
    public LoginResponse(String refreshToken, Date tokenExpirationDate, Date refreshTokenExpirationDate, Integer id, String username, String email, String name, String lastName, boolean enabled, List<String> roles, String tokenType, String accessToken) {
